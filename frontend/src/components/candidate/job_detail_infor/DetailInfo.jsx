...
const getHinhThuc = (id) => "Full-time";
const getGioiTinh = (id) => "Không yêu cầu";
    ...
    return (
        <div className={s.job_info_header}>
            ...
            <div className={s.job_info_content_1}>
                <h1 className={s.text}>Tìm việc làm nhanh vị trí {detailInfo.title}</h1>
            </div>
            ...
            <div className={s.job_info_content_2}>
                ...
                <div className={s.job_info_item}>
                    ...
                    <div className={s.job_info_detail}>
                        ...
                        <div className={s.job_info_value}>{detailInfo?.bang_cap ? getHocVan(detailInfo.bang_cap) : 'Xem chi tiết tin'}</div>
                    </div>
                </div>
                <div className={s.job_info_item}>
                    <div className={s.job_info_image_1}>
